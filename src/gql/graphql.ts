...
export type CartGetByIdQuery = { order?: { id: string, total: number, orderItems: Array<{ id: string, total: number, quantity: number, product?: { id: string, name: string, description: string, price: number } | null }> } | null };

export type CartFragment = { id: string, total: number, orderItems: Array<{ id: string, total: number, quantity: number, product?: { id: string, name: string, description: string, price: number } | null }> };
...
export type CartRemoveProductMutation = { updateOrder?: { id: string, total: number, orderItems: Array<{ id: string, total: number, quantity: number, product?: { id: string, name: string, description: string, price: number } | null }> } | null };
...
export type CartSetItemQuantityMutation = { updateOrder?: { id: string } | null };

export type CartUpdateOrderMutationVariables = Exact<{
  total: Scalars['Int']['input'];
  quantity: Scalars['Int']['input'];
...
export type CartUpdateOrderMutation = { upsertOrder?: { id: string, total: number, orderItems: Array<{ id: string, total: number, quantity: number, product?: { id: string, name: string, description: string, price: number } | null }> } | null };
...
export type OrderPublishMutation = { publishOrder?: { id: string } | null, publishManyOrderItemsConnection: { aggregate: { count: number } } };

export type OrderUpdateEmailMutationVariables = Exact<{
  email?: InputMaybe<Scalars['String']['input']>;
...
export type OrderUpdateEmailMutation = { updateOrder?: { id: string } | null };

export type OrderGetByUserIdQueryVariables = Exact<{
  userId: Scalars['String']['input'];
}>;


export type OrderGetByUserIdQuery = { orders: Array<{ id: string, total: number, orderItems: Array<{ id: string, total: number, quantity: number, product?: { id: string, name: string, description: string, price: number } | null }> }> };
...
export type ReviewFragment = { id: string, rating: number, headline: string, content: string, name: string };
...
export type ReviewPublishMutation = { publishReview?: { id: string } | null, updateProduct?: { id: string, rating?: number | null } | null, publishProduct?: { id: string, name: string, description: string, price: number, rating?: number | null, categories: Array<{ name: string }>, images: Array<{ url: string }>, variants: Array<{ __typename: 'ProductColorVariant', id: string, color: ProductColor } | { __typename: 'ProductSizeColorVariant', id: string, color: ProductColor, size: ProductSize } | { __typename: 'ProductSizeVariant', id: string, size: ProductSize }> } | null };
...
export type ReviewsAddReviewMutation = { createReview?: { id: string, product?: { rating?: number | null, reviews: Array<{ id: string, rating: number }> } | null } | null };
...
export type ReviewsGetListQuery = { reviews: Array<{ id: string, rating: number, headline: string, content: string, name: string }> };
...
export const CartUpdateOrderDocument = new TypedDocumentString(`
...
}`) as unknown as TypedDocumentString<CartUpdateOrderMutation, CartUpdateOrderMutationVariables>;
...
export const OrderUpdateEmailDocument = new TypedDocumentString(`
  ...
  updateOrder(
    ...
    `) as unknown as TypedDocumentString<OrderUpdateEmailMutation, OrderUpdateEmailMutationVariables>;
export const OrderGetByUserIdDocument = new TypedDocumentString(`
...
}`) as unknown as TypedDocumentString<OrderGetByUserIdQuery, OrderGetByUserIdQueryVariables>;
